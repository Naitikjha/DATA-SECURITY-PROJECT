...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        "it initiate KNN imputer and deal with the all nan value in the data set"
        logging.info("Entered get_transformer_object methord of Transformation class")
        try:
            '** in the KNNIMPUTER func represent paramater goes in the keys values pair'
